...
//    firestore.collection(db_path).document(canteenId).s
  ...
  addMenuItem(int price, int waitingTime,String nameOfItem, int availability, String canteenId) async {
    await firestore.collection(dbPath).document(canteenId).updateData({"items": FieldValue.arrayUnion([{'name': nameOfItem,
